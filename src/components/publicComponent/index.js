...
class PublicComponent extends Component {
    ...
    onFilterSubmit({filed, dateFormat,offset}){
        ...
        let datas = {
            reportName:calcReportName(filed.UPDATE_DATE_START ? filed.UPDATE_DATE_START.format(dateFormat) : '', filed.UPDATE_DATE_END ? filed.UPDATE_DATE_END.format(dateFormat) : '', filed.ORGAN_LEVEL, data[pubChildren].reportName),
            offset:offset || 1,
            limit:10,
            paramMap:{
                DATE_TYPE,
